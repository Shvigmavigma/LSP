...
class User(Base):
    ...
    direction_key = Column(String, nullable=False, default="no_direction", index=True)
...
class Project(Base):
    ...
    class_key = Column(String, nullable=True, index=True)
    direction_key = Column(String, nullable=True)
    ...
    file_quota_overrides = Column(JSON, default=dict)
